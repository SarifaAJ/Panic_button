...
import com.example.panicbutton.adapter.BottomSheetAdapter
import com.example.panicbutton.databinding.ActivityTambahPanicBinding
import com.example.panicbutton.model.BottomSheetData
import com.google.android.material.bottomsheet.BottomSheetDialog

class TambahPanicActivity : AppCompatActivity() {
    // binding
    private lateinit var binding: ActivityTambahPanicBinding
    // bottom sheet dialog
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTambahPanicBinding.inflate(layoutInflater)
        ...
        binding.mapImg.setOnClickListener {
            val intent = Intent(this@TambahPanicActivity, TambahPanic2Activity::class.java)
