...
import com.example.panicbutton.databinding.ActivityProfileOtpBinding

class ProfileOTPActivity : AppCompatActivity() {
    // binding
    private lateinit var binding: ActivityProfileOtpBinding
    // edit text
    private val editTexts = mutableListOf<EditText>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityProfileOtpBinding.inflate(layoutInflater)
        ...
        binding.btnKirim.setOnClickListener {
            val intent = Intent(this@ProfileOTPActivity, ProfileOTP2Activity::class.java)
